	...
	function populateHeader(jsonObj) {
		...
		var myTime = document.createElement('h4');
		myTime.textContent = n + ' ' + time;
		var myH2 = document.createElement('h1');
		myH2.innerHTML = 'Market cap : <a href=\'https://coinmarketcap.com/charts\'>$' + jsonObj['total_market_cap_usd'].toLocaleString() + '</a>';

		var myPara = document.createElement('p');
		myPara.textContent = '24h Vol: $' + jsonObj['total_24h_volume_usd'].toLocaleString()  + ' / BTC Dominance: ' + jsonObj['bitcoin_percentage_of_market_cap'] + '%';

		header.appendChild(myH2);  
		eader.appendChild(myTime);
